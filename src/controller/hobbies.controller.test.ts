// C import { NextFunction, Request, Response } from 'express';
...
//       ];
//       const repoMock = jest.spyOn(HobbiesMongoRepo.prototype, 'getAll').mockResolvedValue(mockHobbies);
//       // Cconst controller = new HobbiesController();
//       const mockResponse: Partial<Response> = {
//         json: jest.fn(),
//       };
//       // Cawait controller.getAll({} as Request, mockResponse as Response);
...
//       const repoMock = jest.spyOn(HobbiesMongoRepo.prototype, 'getById').mockResolvedValue(mockHobby);
...
//       const repoMock = jest.spyOn(HobbiesMongoRepo.prototype, 'getById').mockRejectedValue(new Error('Test error'));
//       const controller = new HobbiesController();
//       const mockRequest: Partial<Request> = {
//         params: { id: '1' },
//       };
...
//       const repoMock = jest.spyOn(HobbiesMongoRepo.prototype, 'create').mockResolvedValue(mockCreatedHobby);
//       const controller = new HobbiesController();
//       const mockRequest: Partial<Request> = {
//         body: mockNewHobby,
//       };
...
//           const hobbiesFileRepoMock = jest.spyOn(HobbiesMongoRepo.prototype, 'update').mockResolvedValue(mockUpdatedResult);
//           const controller = new HobbiesController();
...
//         const mockId = '123';
//         const hobbiesFileRepoMock = jest.spyOn(HobbiesMongoRepo.prototype, 'delete').mockResolvedValue(undefined);
//         const controller = new HobbiesController();
//         const mockRequest: Request = {
//           params: { id: mockId },
//         } as unknown as Request;
...
//         const hobbiesFileRepoMock = jest.spyOn(HobbiesMongoRepo.prototype, 'delete').mockRejectedValue(mockError);
//         const controller = new HobbiesController();
//         const mockRequest: Request = {
//           params: { id: mockId },
//         } as unknown as Request;
